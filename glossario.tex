...
\newglossaryentry{Solr}
{
	...
	text=Sorl,
	sort=solr,
	description={Piattaforma di ricerca \gls{open source}. E' scritto in \gls{Java} e viene eseguito come server di ricerca full text indipendente all'interno di un contenitore \gls{Servlet}. Solr usa la libreria di ricerca \gls{Java Lucene} per la ricerca e l'indicizzazione full text e mette a disposizione chiamate \gls{REST} in vari formati, come ad esempio \gls{JSONg} e \gls{XMLg}, rendendo semplice la comunicazione}
}
